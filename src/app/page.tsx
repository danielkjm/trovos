...
import { patientName } from '@/data/patient';
...
export default function Home() {
  ...
  const containerClasses =
    activeView === 'chat'
      ? 'flex flex-1 gap-8 rounded-[40px] bg-white/95 p-8 shadow-[0px_32px_80px_rgba(31,31,56,0.08)]'
      : 'flex flex-1 gap-8 rounded-[40px] bg-[#F9F9FF] p-8 shadow-[0px_32px_80px_rgba(31,31,56,0.12)]';
